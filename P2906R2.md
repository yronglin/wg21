...
This proposal providing a tuple interface so that users can decompose extents with structured bindings, and the dimensions now have meaningful names.
...
[Compiler Explorer](https://godbolt.org/z/dYocKf8cs).
