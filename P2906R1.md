...
An example of such an implementation using GCC trunk's implementation of `<mdspan>` with `-std=c++26` on Godbolt is provided here:
[https://godbolt.org/z/sfMa5zEd5](https://godbolt.org/z/sfMa5zEd5).
...
We would like to thank Christian Trott, Wenming Wang, and June Yang for reviewing and encouraging us to write this proposal.
